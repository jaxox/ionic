...
angular.module('google.places', [])
	 ...
	 *
	 * <input type="text" g-places-autocomplete ng-model="myScopeVar" ng-selected="doAddLocation" />
	 */
            ...
            return {
                ...
                link: function ($scope, element, attrs, controller) {
                    ...
                    function onKeydown(event) {
                        ...
                        if ( indexOf(hotkeys, event.which) === -1) {
                            return;
                        }
                            ...
                            placesService.getDetails({ placeId: prediction.place_id }, function (place, status) {
                                if (status == google.maps.places.PlacesServiceStatus.OK) {
                                    $scope.$apply(function () {
                                        ...
                                        //call back function to process the place
                                        // copy to the list
                                        $scope.selectedFunc(place);
